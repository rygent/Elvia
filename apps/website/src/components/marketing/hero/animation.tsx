      ...
      <LayoutGroup>
        {selectedTab === 0 && (
          <motion.div
            ...
            className={cn(
              'h-[450px] w-[350px]',
              !animationStarted && 'duration-500 animate-in fade-in slide-in-from-bottom-3'
            )}
          >
            <h2 className="text-3xl font-bold">fun.</h2>
        ...
        {selectedTab === 1 && (
          <motion.div key={1} {...animationProps} className="h-[450px] w-[350px]">
            <h2 className="text-3xl font-bold">moderation.</h2>
            <div className="mt-4 grid grid-cols-1 gap-4">
