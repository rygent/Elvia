...
export const Topgg = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg role="img" fill="currentColor" version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
