		...
		<MenuBar>
			<MenuBarTrigger className={cn('group data-[state=open]:bg-transparent', className)} asChild {...props}>
				<Button
					variant="ghost"
					size="icon"
					className="relative flex h-8 w-8 flex-col gap-0 rounded-full! border border-border ps-1.5 pe-1.5 duration-200 hover:bg-transparent focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 lg:hidden"
				>
					<span
						data-position="top"
						className="absolute h-[1.5px] w-3.5 translate-y-[-3.5px] bg-foreground transition-transform duration-160 ease-[cubic-bezier(0.31,0.05,0.43,1.02)] group-data-[state=open]:translate-y-0 group-data-[state=open]:scale-110 group-data-[state=open]:rotate-45"
					/>
					<span
