...
import { type CommandData, type CommandOptions, type CommandParameter } from '@/types/command.js';
...
export abstract class CoreCommand extends EventEmitter {
	...
	public constructor(client: CoreClient<true>, options: CommandOptions) {
		super();
		this.client = client;
	...
	public autocomplete(interaction: AutocompleteInteraction<'cached' | 'raw'>, ...args: unknown[]): Awaitable<unknown>;
	public autocomplete() {
