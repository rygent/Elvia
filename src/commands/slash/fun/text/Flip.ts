...
const flipTable = {
	...
	'А': '∀', 'Б': 'ܦ', 'В': 'ꓭ', 'Г': '⅃', 'Д': 'ჩ', 'Е': 'Ǝ', 'З': 'Ɛ', 'Й': 'И̯', 'К': 'ꓘ',
	'Л': 'Ѵ', 'М': 'ꟽ', 'П': 'ⵡ', 'Р': 'Ԁ', 'С': 'Ͻ', 'Т': 'ꓕ', 'У': 'ʎ', 'Ц': 'ŉ', 'Ч': 'Ⴙ',
	'Ш': 'ᗰ', 'Ь': 'ᑫ', 'Э': 'Є', 'Ю': 'Ꙕ', 'Я': 'ᖉ',

	'а': 'ɐ', 'б': 'ܦ', 'в': 'ʚ', 'г': '⅃', 'д': 'ჩ', 'е': 'ǝ', 'з': 'ԑ', 'й': 'и̯', 'к': 'ʞ',
	'л': 'ѵ', 'м': 'ᥕ', 'п': '⊔', 'р': 'd', 'с': 'ɔ', 'т': 'ꓕ', 'у': 'ʎ', 'ц': 'ŉ', 'ч': 'h',
	'ш': 'm', 'ь': '৭', 'э': 'є', 'ю': 'ꙕ', 'я': 'ʁ'
};
